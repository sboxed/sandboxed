...
/// Zoom the story.
class Zoom extends DecoratorInterface {
  final double scale;

  const Zoom({this.scale = 2.0});

  @override
  Widget decorate(BuildContext context, Widget story) {
    return _FittedScale(scale: scale, child: story);
  }
}

// Copied from [fitted_scale](https://github.com/wahahachan/fitted_scale) package
class _FittedScale extends SingleChildRenderObjectWidget {
  ...
  /// {@end-tool}
  ///
  _FittedScale({this.scale, this.scaleX, this.scaleY, super.child})
  ...
  @override
  _RenderScaledBox createRenderObject(BuildContext context) =>
      _RenderScaledBox(transform: transform);

  @override
  void updateRenderObject(BuildContext context, _RenderScaledBox renderObject) {
    renderObject.transform = transform;
  }
}

class _RenderScaledBox extends RenderBox
