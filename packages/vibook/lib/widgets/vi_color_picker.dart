...
import 'package:vibook/utility/hex_color.dart';

class ViColorPicker extends StatefulWidget {
  final Color value;
  ...
  @override
  State<ViColorPicker> createState() => _ViColorPickerState();
}

class _ViColorPickerState extends State<ViColorPicker> {
