...
Meta get meta => const Meta<AbstractWidget>(name: "Edge Cases / Abstract Widgets");

Story get $Default => Story(
  builder: (context, params) => ImplementerWidget(name: params.string('name').required("John Doe")),
);
